...
$name = ucwords($name);  //capitalizing first word of name
...
$adjective_file		    = file_get_contents('data/adjective.txt');
$amount_file		    = file_get_contents('data/amount.txt');
$animal_file		    = file_get_contents('data/animal.txt');
$animal_part_file	    = file_get_contents('data/animal_part.txt');


//exploding list and putting them in arrays
$adjective_rows		    = explode("_", $adjective_file);
$amount_rows        	= explode("_", $amount_file);
$animal_rows        	= explode("_", $animal_file);
$animal_part_rows	    = explode("_", $animal_part_file);
...
//Switch case for generating insults
